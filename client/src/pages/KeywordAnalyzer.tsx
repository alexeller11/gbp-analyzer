...
interface KeywordResult {
  ...
  inReviews: boolean; inPosts: boolean; inName: boolean;
  suggestion: string;
}
      ...
      <div className="space-y-6 max-w-3xl mx-auto">
        ...
        <Card>
          <CardContent className="pt-4 space-y-3">
            ...
            />
            <Button onClick={handleAnalyze} disabled={analyzing || !keywords.trim()} className="w-full gap-2 h-11">
                ...
                <Card key={i} className="border-l-4" style={{ borderLeftColor: scoreHex(r.score) }}>
                  <CardContent className="pt-4">
                    ...
                    <div className="grid grid-cols-5 gap-1 mb-3">
                      {[["Nome", r.inName], ["Descrição", r.inDescription], ["Serviços", r.inServices], ["Reviews", r.inReviews], ["Posts", r.inPosts]].map(([label, present]) => (
